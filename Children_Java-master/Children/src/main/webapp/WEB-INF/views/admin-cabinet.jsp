        ...
        <div class="tabs tabs-style-linemove">
            <nav>
                <ul>
                    ...
                    <li><a href="#section-linemove-3" class="icon fa fa-home"><span>Всі будинки</span></a></li>
                    <li><a href="#section-linemove-4" class="icon fa fa-sitemap"><span>Категорії подарунків</span></a></li>
                    <li></li>
                </ul>
            </nav>
            <div class="content-wrap">
                                ...
                                <div class="col-md-6">
                                    <div class="fh5co-press-item to-animate">
                                        ...
                                        <div class="fh5co-press-text">
                                            <h3 class="h2 fh5co-press-title">${r.name}<span class="fh5co-border"></span></h3>
                ...
                <section id="section-linemove-4">
                    <div id="fh5co-press" data-section="press">
                        <button class="add-child-btn btn btn-primary hvr-grow to-animate" data-toggle="modal" data-target="#add-category"><i class="fa fa-plus"></i><span>Додати категорію</span></button>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="fh5co-press-item to-animate">
